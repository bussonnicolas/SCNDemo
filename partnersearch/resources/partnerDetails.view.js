sap.ui.jsview("partnersearch.resources.partnerDetails", {

	getControllerName : function() {
		return "partnersearch.resources.partnerDetails";
	},
	...
	createFirstDetailPartner:function(){
		...
		var oMatrix = new sap.ui.commons.layout.MatrixLayout({
			...
			oMatrix.createRow(
					new sap.ui.commons.Label({text: oBundle.getText("PARTNER_CHTIM"), design:sap.ui.commons.LabelDesign.Bold }),
					new sap.ui.commons.TextView("ID_partnerDetails_Partner_Chtim_1",{editable:false })
			);
			oMatrix.createRow(
					new sap.ui.commons.Label({text: oBundle.getText("PARTNER_CHDAT"), design:sap.ui.commons.LabelDesign.Bold }),
					new sap.ui.commons.TextView("ID_partnerDetails_Partner_Chdat_1",{editable:false })
			);
			oMatrix.createRow(
