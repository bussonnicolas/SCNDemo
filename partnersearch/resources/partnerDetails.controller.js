sap.ui.controller("partnersearch.resources.partnerDetails", {
	...
	setPartnerFirstDetails:function(oContext){
		...
		oModel.read("",oContext,[],false,
				function(oData,response){
						...
						sap.ui.getCore().byId("ID_partnerDetails_Partner_Chtim_1").setText(oData["Chtim"]);
						sap.ui.getCore().byId("ID_partnerDetails_Partner_Chdat_1").setText(fnDateFormatter(oData["Chdat"]));
