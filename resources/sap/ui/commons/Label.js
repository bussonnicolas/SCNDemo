...
sap.ui.commons.Label.prototype.onAfterRendering=function(){if(this.getLabelFor()&&(this.getTooltip_AsString()==""||!(this.getTooltip()instanceof sap.ui.core.TooltipBase))){var f=sap.ui.getCore().byId(this.getLabelFor());if(f&&(f.getTooltip()instanceof sap.ui.core.TooltipBase)){this.oForTooltip=f.getTooltip();this.addDelegate(this.oForTooltip)}}};
