...
sap.ui.commons.ValueHelpField.prototype.onsapshow=function(e){this.fireValueHelpRequest({});e.preventDefault();e.stopPropagation()};
...
sap.ui.commons.ValueHelpField.prototype.onThemeChanged=function(e){var i=this.getValueHelpIconUrl();var I=jQuery.sap.byId(this.getId()+'-icon');I.attr('src',i)};
