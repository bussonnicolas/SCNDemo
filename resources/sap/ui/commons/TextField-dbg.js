...
sap.ui.commons.TextField.prototype.onsapnextmodifiers = function(oEvent) {
	// As long there is no edit mode in itemNavigation a possibility to navigate the cursor in the
	// TextField is needed. So it's possible via shift+arrow (select text) and ctrl+arrow (move cursor)
	// This is NOT the final solution!!!
	oEvent.stopPropagation();

};

sap.ui.commons.TextField.prototype.onsappreviousmodifiers = function(oEvent) {
	// As long there is no edit mode in itemNavigation a possibility to navigate the cursor in the
	// TextField is needed. So it's possible via shift+arrow (select text) and ctrl+arrow (move cursor)
	// This is NOT the final solution!!!
	oEvent.stopPropagation();
