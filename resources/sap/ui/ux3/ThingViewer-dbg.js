 ...
 * <li>{@link #getSecondTitle secondTitle} : string</li></ul>
 * </li>
 * <li>Aggregations
 * <ul>
 ...
 * @public
 * @since 1.8.0
 * @experimental Since version 1.8.0. 
 ...
 * @public
 * @name sap.ui.ux3.ThingViewer#getFirstTitle
 * @function
 */
 ...
 * @public
 * @name sap.ui.ux3.ThingViewer#setFirstTitle
 * @function
 */
 ...
 * @public
 * @name sap.ui.ux3.ThingViewer#getSecondTitle
 * @function
 */
 ...
 * @return {sap.ui.ux3.ThingViewer} <code>this</code> to allow method chaining
 * @public
 * @name sap.ui.ux3.ThingViewer#setSecondTitle
 * @function
 */
...
(function() {
	...
	//Implementation of API method
	sap.ui.ux3.ThingViewer.prototype.setFirstTitle = function(sTitle) {
		this.setProperty("firstTitle", sTitle, true);
		this._rerenderHeader();
	};
	//Implementation of API method
	sap.ui.ux3.ThingViewer.prototype.setSecondTitle = function(sTitle) {
		this.setProperty("secondTitle", sTitle, true);
		this._rerenderHeader();
	};
	// Implementation of API method
